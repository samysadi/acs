 ...
 * The host is chosen according to the first fit method.<br/>
 * If none is found then a new host is powered on.
 * 
 * @since 1.0
 */
public class VmPlacementPolicyFirstFit extends VmPlacementPolicyAbstract {

	public VmPlacementPolicyFirstFit() {
		super();
	}
