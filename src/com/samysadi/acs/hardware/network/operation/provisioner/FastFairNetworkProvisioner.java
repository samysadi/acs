 ...
 * @since 1.0
 */
public class FastFairNetworkProvisioner extends FastFairProvisioner<NetworkOperation, NetworkResource>
	 ...
	 * You should use {@link FastFairNetworkProvisioner#FastFairNetworkProvisioner(long, long, double)} though.
	 */
	public FastFairNetworkProvisioner() {
		this(0l, 0l, 0d);
	}

	public FastFairNetworkProvisioner(long bwCapacity, long latency, double lossRate) {
		super();
	...
	@Override
	public FastFairNetworkProvisioner clone() {
		final FastFairNetworkProvisioner clone = (FastFairNetworkProvisioner) super.clone();
		return clone;
	}
