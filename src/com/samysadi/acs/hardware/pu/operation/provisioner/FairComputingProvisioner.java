...
public class FairComputingProvisioner extends FairProvisioner<ComputingOperation, ComputingResource>
	 ...
	 * You should use {@link FairComputingProvisioner#FairComputingProvisioner(long)} though.
	 */
	public FairComputingProvisioner() {
		this(0l);
	}

	public FairComputingProvisioner(long mipsCapacity) {
		super();
		this.capacity = mipsCapacity;
	}

	@Override
	public FairComputingProvisioner clone() {
		final FairComputingProvisioner clone = (FairComputingProvisioner) super.clone();
		return clone;
	}
