 ...
 * @since 1.0
 */
public class FairStorageProvisioner extends FairProvisioner<StorageOperation, StorageResource>
	 ...
	 * You should use {@link FairStorageProvisioner#FairStorageProvisioner(long)} though.
	 */
	public FairStorageProvisioner() {
		this(0l);
	}

	public FairStorageProvisioner(long transferRateCapacity) {
		super();
		this.capacity = transferRateCapacity;
	}

	@Override
	public FairStorageProvisioner clone() {
		final FairStorageProvisioner clone = (FairStorageProvisioner) super.clone();
		return clone;
	}
