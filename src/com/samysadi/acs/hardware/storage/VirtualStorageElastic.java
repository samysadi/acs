...
import com.samysadi.acs.hardware.misc.VirtualMemoryUnitElastic;
...
/**
 * @see VirtualMemoryUnitElastic
 * @author Samy Sadi <samy.sadi.contact@gmail.com>
 * @author Belabbas Yagoubi <byagoubi@gmail.com>
 * @since 1.0
 */
public class VirtualStorageElastic extends VirtualMemoryUnitElastic<StorageFile, Storage> implements VirtualStorage {
	 ...
	 * You should use {@link VirtualStorageElastic#VirtualStorageElastic(long)} though.
	 */
	public VirtualStorageElastic() {
		this(0);
	}

	public VirtualStorageElastic(long capacity) {
		super(capacity);
	...
	@Override
	public VirtualStorageElastic clone() {
		final VirtualStorageElastic clone = (VirtualStorageElastic) super.clone();
		return clone;
	}
