 ...
 * @since 1.0
 */
public class VirtualRamElastic extends VirtualMemoryUnitElastic<RamZone, Ram> implements VirtualRam {
	 ...
	 */
	public VirtualRamElastic() {
		this(0);
	}

	public VirtualRamElastic(long capacity) {
		super(capacity);
	}

	@Override
	public VirtualRamElastic clone() {
		final VirtualRamElastic clone = (VirtualRamElastic) super.clone();
		return clone;
	}
