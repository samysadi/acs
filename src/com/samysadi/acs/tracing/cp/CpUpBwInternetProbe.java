...
import com.samysadi.acs.tracing.host.HostUpBwInternetProbe;
	...
	public void setup(Probed parent) {
		...
		//register listeners
		{
			...
			for (Host h: ((CloudProvider)getParent()).getHosts())
				h.getProbe(HostUpBwInternetProbe.KEY); //create needed probes
	...
	private static final class MyStaticListener0 extends NotificationListener {
		...
		protected void notificationPerformed(Notifier notifier,
			...
			if (data instanceof Host)
				((Host) data).getProbe(HostUpBwInternetProbe.KEY); //create needed probes
		}
	}
