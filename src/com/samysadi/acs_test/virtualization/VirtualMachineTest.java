...
package com.samysadi.acs_test.virtualization;
...
public class VirtualMachineTest extends RunnableEntityTest {
	...
	public RunnableEntity startRunnableEntity() {
		VirtualMachine vm = Factory.getFactory(simulator).newVirtualMachine(null);
		vm.setParent(cloudProvider.getHosts().get(0));
		vm.doStart();
		return vm;
	}
